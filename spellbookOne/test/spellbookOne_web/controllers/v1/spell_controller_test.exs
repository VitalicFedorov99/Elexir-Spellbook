defmodule SpellbookOneWeb.V1.SpellControllerTest do
  ...
  test "index/2 returns bad list items", %{conn: conn} do
    [spell_1, spell_2, spell_3] = insert_list(3, :spell)
    ...
    assert response ==
    [
      %{"id"=> spell_1.id, "name" => spell_1.name, "rang" => spell_1.rang},
      %{"id"=> spell_2.id, "name" => spell_2.name, "rang" => spell_2.rang},
      %{"id"=> spell_3.id, "name" => spell_3.name, "rang" => spell_3.rang}
    ]
  end
end
