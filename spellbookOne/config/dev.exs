...
config :spellbookOne, SpellbookOneWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "A28B66IsvRcqsTu9wzfcqdz7i4XAErfwVP6S6TIaMzf03H1uZYMVn8prC9JbJJG4",
  watchers: [
...
config :spellbookOne, SpellbookOneWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/spellbookOne_web/(live|views)/.*(ex)$",
      ~r"lib/spellbookOne_web/templates/.*(eex)$"
    ]
  ]
